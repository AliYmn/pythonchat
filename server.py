...
def clientThread(client):
    ...
    users[client] = user
    try:
        client.send("Hi {}! You are now connected to Python Chat. Type \"/help\" for a list of available commands!".format(user).encode("utf8"))
    except:
...
def getNickname(client):
    ...
    client.send("Welcome to Python Chat! Please type your nickname :".encode("utf8"))
...
def main():
    ...
    print("Python Chat server is up and running!")
